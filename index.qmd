...
# Lemons node (yellow)
pgm.add_node("lemons", "Lemons (X)", 1, 1, aspect=2, scale=1.1,
             plot_params={
                 'facecolor': 'gold',
...
# Scurvy node (sickly/unpleasant color)
pgm.add_node("scurvy", "Scurvy (Y)", 3, 1, aspect=2, scale=1.1,
             plot_params={
                 'facecolor': '#8B7355',
                 'edgecolor': '#5C4033',
                 'linewidth': 2,
...
# Acid node (green) - spaced left
pgm.add_node("acid", "Acid (X)", 0, 1, aspect=2, scale=1.1,
             plot_params={
                 'facecolor': 'palegreen',
                 'edgecolor': 'darkgreen',
                 'linewidth': 2,
...
# Bacteria in food node - center
pgm.add_node("bacteria", "Bacteria\nin food (Y)", 2.5, 1, aspect=2, scale=1.1,
             plot_params={
                 'facecolor': 'lavender',
                 'edgecolor': 'purple',
                 'linewidth': 2,
...
# Scurvy node (same as DAG 1) - spaced right
pgm.add_node("scurvy", "Scurvy (Z)", 5, 1, aspect=2, scale=1.1,
             plot_params={
                 'facecolor': '#8B7355',
                 'edgecolor': '#5C4033',
                 'linewidth': 2,
...
# Vitamin C node (appealing citrus/health color)
pgm.add_node("vitamin_c", "Vitamin C (X)", 0, 1, aspect=2.2, scale=1.2,
             plot_params={
                 'facecolor': '#FFE4C4',
                 'edgecolor': '#D2691E',
                 'linewidth': 2,
...
pgm.add_node("collagen", "Collagen\nsynthesis (Y)", 2.5, 1, aspect=2.2, scale=1.2,
             plot_params={
                 'facecolor': '#E0F7FA',
                 'edgecolor': '#00838F',
                 'linewidth': 2,
...
# Scurvy node (same as DAG 1 and 2)
pgm.add_node("scurvy", "Scurvy (Z)", 5, 1, aspect=2.2, scale=1.2,
             plot_params={
                 'facecolor': '#8B7355',
                 'edgecolor': '#5C4033',
                 'linewidth': 2,
